...
public class UserControllerTest {
    ...
    @ParameterizedTest(name = "{index} При невалидных данных пользователя сервер должен возвращать ошибку BadRequest")
    @MethodSource("userInvalidParameters")
    void addInvalidUserTest(long id, String login, String email, String name, LocalDate birthday) throws Exception {
